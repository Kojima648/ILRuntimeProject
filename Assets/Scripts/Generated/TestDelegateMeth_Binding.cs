...
{
    unsafe class TestDelegateMeth_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::TestDelegateMeth);
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::TestDelegateMeth instance_of_this_method = (global::TestDelegateMeth)typeof(global::TestDelegateMeth).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
